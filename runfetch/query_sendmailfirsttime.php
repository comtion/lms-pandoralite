...
$arr_email = array();
$lang = "english";
$sql_rechk = "SELECT * FROM `lms_usp` where lms_usp.u_createdate like '%2020-08-13%' and lms_usp.firsttime=1 and lms_usp.u_id != '955'";
			...
			$numtotal++;
                  ...
                  //echo $fetch_userposi['email']."<br>";
                        //if(count($fetch_userposi)>0&&!in_array($fetch_userposi['email'], $arr_email)){
									...
									//print_r($fetch_rechk['email']);
				            			//echo $fetch_rechk['email']."::233:::<br>";
		            						//array_push($arr_email, $fetch_rechk['email']);
                          ...
                          //}
                                ...
                                $sql_update = 'update lms_usp set userp="'.$password_enc.'" where u_id = "'.$fetch_userposi['u_id'].'"';
                                //echo $sql_update."<br>";
