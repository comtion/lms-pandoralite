            ...
            ?>
              ...
              <div class="container-fluid p-0 mb-3">
                <a href="#" class="btn btn-block <?php if($value_pretest['status_tc']=="3"){ ?>imat-red-bg btn-danger<?php } ?> waves-effect waves-light rounded-0 text-left" type="button" data-toggle="collapse" data-target="#collapseExample_<?php echo $value_pretest['qiz_id']; ?>" aria-expanded="false" aria-controls="collapseExample_<?php echo $value_pretest['qiz_id']; ?>" style="background-color: #95a5a6;color: #ecf0f1;border-color: #95a5a6;">
                  <?php echo label('preExam').": ".$quiz_name; ?>
                          ...
                          ?>
                            ...
                            <div class="tab-pane <?php if($numpretest==1){ ?>active show<?php } ?>" id="quiz_<?php echo $value_pretest['qiz_id']."_".$numloop; ?>" role="tabpanel">
                              ...
                              <?php }else{
                                ...
                                <label  onclick="onselectVal('pretest','<?php echo $value_ques['ques_id']; ?>','<?php echo $arr_choice[$choicenum]['value_choice']; ?>')" for="multi_choice_group_pretest_<?php echo $value_ques['ques_id']; ?><?php echo  $arr_choice[$choicenum]['num_choice']; ?>"><?php echo strip_tags($arr_choice[$choicenum]['name_choice'],"<label>"); ?></label>
                                <br>
                                          <?php
                                        }
/*                                 
<?php if($tc_answer==$arr_choice[$choicenum]['value_choice']){echo "checked";} ?>
 <?php if($value_pretest['status_tc']=="3"){if($value_pretest['quiz_grade']=="1"&&in_array($arr_choice[$choicenum]['value_choice'], $mul_answer)){ if($tc_answer==$arr_choice[$choicenum]['value_choice']){?>class="label label-light-success"<?php }}else{if($tc_answer==$arr_choice[$choicenum]['value_choice']){?>class="label label-light-danger"<?php }}} ?>
                                        $tc_answer = isset($value_ques['tc']['tc_answer'])?$value_ques['tc']['tc_answer']:"";
                                        if($mul_c1!=""){
                              ?>
                ...
                <div class="collapse" id="collapseExample_lesson">
                    ...
                    <div class="card card-body">
                        <div class="vtabs customvtab row">
                          ...
                          <?php $numlesson = 0;
                                foreach ($lesson_arr as $key_lesson => $value_lesson) { $numlesson++;?>
                            <div class="tab-pane <?php if($numlesson==1){ ?>active show<?php } ?>" id="lesson_<?php echo $value_lesson['les_id']; ?>" role="tabpanel">
                          <?php 
                      ...
                      <?php }
                            echo $value_lesson['les_info']!=""?"<div>".$value_lesson['les_info']."<hr></div>":""; 
...
<?php if(countArray($posttest_arr)>0){
            ...
            ?>
              ...
              <div class="container-fluid p-0 mb-3">
                <a href="#" id="quizheader<?php echo $value_posttest['qiz_id']; ?>" class="btn btn-block waves-effect waves-light rounded-0 text-left" type="button" data-toggle="collapse" data-target="#collapseExample_<?php echo $value_posttest['qiz_id']; ?>" aria-expanded="false" style="background-color: #95a5a6;color: #ecf0f1;border-color: #95a5a6;" aria-controls="collapseExample_<?php echo $value_posttest['qiz_id']; ?>" >
                  <span id="txtstatus_quiz<?php echo $value_posttest['qiz_id']; ?>"></span>  <?php echo label('finalExam').": ".$quiz_name; ?>
                  <i class="fa fa-chevron-right float-right"></i>
                  <i class="fa fa-chevron-down float-right"></i>
                </a>
                          ...
                          ?>
                            ...
                            <div class="tab-pane <?php if($numposttest==1){ ?>active show<?php } ?>" id="quiz_<?php echo $value_posttest['qiz_id']."_".$numloop; ?>" role="tabpanel">
                              ...
                              <?php }else{
                                ...
                                <label onclick="onselectVal('posttest','<?php echo $value_ques['ques_id']; ?>','<?php echo $arr_choice[$choicenum]['value_choice']; ?>')" for="multi_posttest_<?php echo $value_ques['ques_id']; ?><?php echo  $arr_choice[$choicenum]['num_choice']; ?>"><?php echo strip_tags($arr_choice[$choicenum]['name_choice'],"<label>"); ?></label>
                                <br>
                                          <?php
                                        }
                                      }
