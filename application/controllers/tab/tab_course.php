                    ...
                    <div class="col-md-6 input_doccos_jp" style="display:none;">
                        <div class="ribbon-wrapper card">
                            ...
                            <div class="ribbon-content row">
                              <div class="form-group col-md-12">
                                  <label class="control-label"><b style="color: #FF2D00">*</b><?php echo label('file_name'); ?>:</label>
                                  <input name="name_file_jp" type="text" class="form-control" id="name_file_jp">
                              </div>
                            </div>
                        </div>
                    </div>
                <div class="form-group col-md-12" id="cos_filedocument">
                    <label class="control-label"><b style="color: #FF2D00">*</b><?php echo label('file_document'); ?></label>
                            ...
                            <div class="" id="div_multifile_upload_file" style="display: none;"><br>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 input_les_jp">
                                        <label class="control-label text-right"><b style="color: #FF2D00">*</b><?php echo label('file_name')." ".label('japan'); ?></label>
                              ...
                              <table id="myTable_document" width="100%" border="1" class="table table-bordered table-striped">
                                <thead>
                                  <tr>
                                    ...
                                    <th width="20%" class="input_les_jp"><center><?php echo label('file_name')." ".label('acro_jp'); ?></center></th>
    ...
    <div class="card-body"> 
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="row">
                              ...
                              <div class="col-4 text-center">
                                <div class="switch">
                                  <label>
                                    <input type="checkbox"  id="quiz_ishint" name="quiz_ishint" value="1">
                                    <span class="lever switch-col-indigo"></span>
                                  </label>
                                </div>
                              </div>
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          ...
                          <div class="form-group col-md-4 div_lastquiz" >
                              ...
                              <input name="quiz_maxscore" required  type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" value="0" class="form-control" id="quiz_maxscore">
                          </div>
                  ...
                  <table id="myTable_quiz" width="100%" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        ...
                        <th width="10%"></th>
                        <th width="10%"><center><?php echo label('faqlang'); ?></center></th>
                        <th width="20%"><center><?php echo label('qName'); ?></center></th>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                  <table id="myTable_quiz_question_check" width="100%" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th width="20%" align="center"><?php echo label('username'); ?></th>
                        ...
                        <th width="15%" align="center"><?php echo label('maxScore'); ?></th>
                        <th width="15%" align="center"><?php echo label('score'); ?></th>
                      </tr>
                    </thead>
                  </table>
                </div>
        ...
        <div id="div_quiz_detail" style="display: none;">
            <div id="div_quiz_question" class="col-md-12">
                ...
                <p><?php echo label('preNote'); ?> : <button type="button" class="btn btn-info btn-xs quiz_detail"><i class="mdi mdi-check-circle"></i></button> = <b><?php echo label('chk_answer'); ?></b><?php if($btn_update=="1"){ ?> , <button type="button" class="btn btn-warning btn-xs"><i class="mdi mdi-lead-pencil"></i></button> = <b><?php echo label('m_edit'); ?></b><?php } ?><?php if($btn_update=="1"&&$btn_delete=="1"){ ?> , <?php } ?><?php if($btn_delete=="1"){ ?><button type="button" class="btn btn-danger btn-xs"><i class="mdi mdi-window-close"></i></button> = <b><?php echo label('delete'); ?></b><?php } ?></p>
            </div>
                        ...
                        <div class="col-md-12 input_ques_th" style="display:none;">
                            <div class="ribbon-wrapper card">
                                ...
                                <div class="ribbon-content row">
                                  ...
                                  <div class="form-group col-md-6">
                                      <label class="control-label text-right"><?php echo label('summary'); ?></label>
                        ...
                        <div class="col-md-6 input_quesdetail_jp" style="display:none;">
                            <div class="ribbon-wrapper card">
                                ...
                                <div class="ribbon-content row">
                                  ...
                                  <div class="form-group col-md-12">
                                      <label class="control-label text-right"><?php echo label('detail'); ?></label>
                                      <textarea name="ques_hintdetail_jp" id="ques_hintdetail_jp" rows="8" class="form-control"></textarea>
                                  </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="" id="div_multifile_upload_file_videocourse" style="display: none;">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 input_cosv_jp" style="display: none;">
                                        <label class="control-label text-right"><?php echo label('file_name')." (".label('jp').")"; ?></label>
                                        <input name="cosv_jp" type="text" class="form-control" id="cosv_jp">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label class="control-label text-right"><b style="color: #FF2D00">*</b><?php echo label('thumbnail_med'); ?></label><input type="file" name="cosv_thumbnail" id="cosv_thumbnail" class="dropify" accept="image/jpeg" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="control-label text-right"><b style="color: #FF2D00">*</b><?php echo label('media_file')." (".label('max_file').")"; ?></label>
                    ...
                    <div class="form-group col-md-12" id="div_empcode" align="left">
                        <div class="row">
                            ...
                            <div class="col-md-5"><br>
                              <button type="button" onclick="add_employeetocourse()" class="btn btn-outline-info btn-block"><i class="mdi mdi-plus"></i> <?php echo ucwords(label('e_add')); ?></button>
                            </div>
                        </div>
                    </div>
                      ...
                      <table id="myTable_enroll" width="100%" class="table table-bordered table-striped">
                          <thead>
                            <tr>
                              ...
                              <th width="25%"><center><?php echo label('r_name'); ?></center></th>
                              <th width="20%"><center><?php echo label('m_company'); ?></center></th>
                              <th width="20%"><center><?php echo label('status'); ?></center></th>
