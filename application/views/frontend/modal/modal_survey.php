              ...
              <div class="modal-body row">
                    ...
                    <div class="block">
                        ...
                        <div class="row text-center">
                          ...
                          <div class="col-md-4 col-lg-2 text-center">
                            <div class="switch">
                              <label>
                                <input type="checkbox"  id="sv_isHeader" name="sv_isHeader" value="1">
                                <span class="lever switch-col-indigo"></span>
                              </label>
                            </div>
                          </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <input name="sv_expire_noti"  type="text" class="form-control" id="sv_expire_noti" oninput="this.value = this.value.replace(/[^0-9,]/g, '').replace(/(\..*)\./g, '$1');">
                        ...
                        <div class="col-md-12 progress" id="progress_publicsurvey_div" style="display: none;">
                            <div class="progress-bar-publicsurvey bg-danger" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0%; height:6px;"><span class="sr-only" id="txt_progress_publicsurvey"></span></div>
                        </div>
              </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body row">
                        ...
                        <div class="card-body">
                          <div class="col-md-12">
                            <?php if($btn_add=="1"){ ?>
                              ...
                              <button name="import_button_question" id="import_button_question" class="btn btn-outline-info import_button_question float-right"><i class="mdi mdi-upload"></i> <?php echo label('import_data_question'); ?></button>
                            <?php } ?>
                          </div>
                              ...
                              <table id="myTable_question" width="100%" class="table table-bordered table-striped">
                                <thead>
                                  <tr>
                                    ...
                                    <?php } ?>
                                    <th width="5%"></th>
                                    <th width="10%" align="center"><center><?php echo label('questitle'); ?></center></th>
                                    <th width="10%" align="center"><center><?php echo label('sv_b_question_type'); ?></center></th>
                                    <th width="25%" align="center"><center><?php echo label('sv_b_question'); ?></center></th>
                                    <th width="25%" align="center"><center><?php echo label('sv_b_choice'); ?></center></th>
                    ...
                    <div id="div_import_question" class="col-md-12" style="display: none;">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-outline-danger float-right previous_survey"><i class="mdi mdi-keyboard-return"></i> <?php echo label('m_previous'); ?></button>
                        ...
                        <form  enctype="multipart/form-data" id="question_import_form" name="question_import_form" autocomplete="off" method="POST" accept-charset="utf-8"  class="form-horizontal p-t-20 row">
                                <div class="col-md-6">
                                    ...
                                    <?php echo label('certificate_example').": "; ?><a href="<?php echo REAL_PATH;?>/uploads/format/format_import_question_insurvey.xlsx" download>format_import_question_insurvey.xlsx</a><br>
                                    ...
                                    <input type="hidden" id="sv_id_question_import" name="sv_id_question_import">
                                </div>

                                  <div class="col-md-6">
                                      <h4><i class="mdi mdi-format-list-numbers"></i> <?php echo label('result_import'); ?>:</h4>
                                      <div id="result_import_question" class="slimtest1" style="max-height: 290px;position: relative;overflow-y: auto;"></div>
                                  </div>
                                  <div class="col-md-12 progress" id="progress_publicsurveyimport_div" style="display: none;">
                                      <div class="progress-bar-publicsurveyimport bg-danger" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0%; height:6px;"><span class="sr-only" id="txt_progress_publicsurveyimport"></span></div>
                                  </div>
                                  <div class="form-group col-md-12" align="right">
                                      ...
                                      <button type="button" class="btn btn-outline-danger btn-flat previous_survey"><i class="mdi mdi-window-close"></i> <?php echo label('m_cancel'); ?></button>
                                  </div>
                        </form>
                    </div>
                            ...
                            <div class="col-md-12 row" style="">
                                ...
                                <div class="col-md-12 input_svde_eng" style="display:none;">
                                    <div class="ribbon-wrapper card">
                                        <div class="ribbon ribbon-danger"><i class="flag-icon flag-icon-us"></i> <?php echo label('english'); ?></div>
                                        <div class="ribbon-content row">
                                            <div class="form-group col-md-12 col-lg-12 svde_header">
                                                <label class="control-label"><b style="color: #FF2D00">*</b><?php echo label('sv_b_title'); ?>:</label>
                                                <input type="text" class="form-control" id="svde_header_eng" name="svde_header_eng">
                                            </div>
                                            <div class="form-group col-md-12 col-lg-6">
                                ...
                                <div class="col-md-12 input_svde_th" style="display:none;">
                                    <div class="ribbon-wrapper card">
                                        ...
                                        <div class="ribbon-content row">
                                            <div class="form-group col-md-12 col-lg-12 svde_header">
                                                <label class="control-label"><b style="color: #FF2D00">*</b><?php echo label('sv_b_title'); ?>:</label>
                                                <input type="text" class="form-control" id="svde_header_th" name="svde_header_th">
                                            </div>
                                            <div class="form-group col-md-12 col-lg-6">
                                                <label class="control-label"><b style="color: #FF2D00">*</b><?php echo label('sv_b_question'); ?>:</label>
                                ...
                                <div class="col-md-12 input_svde_jp" style="display:none;">
                                    <div class="ribbon-wrapper card">
                                        ...
                                        <div class="ribbon-content row">
                                            <div class="form-group col-md-12 col-lg-12 svde_header">
                                                <label class="control-label"><b style="color: #FF2D00">*</b><?php echo label('sv_b_title'); ?>:</label>
                                                <input type="text" class="form-control" id="svde_header_jp" name="svde_header_jp">
                                            </div>
                                ...
                                <div class="col-md-12 input_svdedetail_eng" style="display:none;">
                                    <div class="ribbon-wrapper card">
                                        ...
                                        <div class="ribbon-content row">
                                            ...
                                            <div class="form-group col-md-6 mul_c6">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 6"; ?></label>
                                                <textarea name="mul_c6_eng" id="mul_c6_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c7">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 7"; ?></label>
                                                <textarea name="mul_c7_eng" id="mul_c7_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c8">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 8"; ?></label>
                                                <textarea name="mul_c8_eng" id="mul_c8_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c9">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 9"; ?></label>
                                                <textarea name="mul_c9_eng" id="mul_c9_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c10">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 10"; ?></label>
                                                <textarea name="mul_c10_eng" id="mul_c10_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c11">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 11"; ?></label>
                                                <textarea name="mul_c11_eng" id="mul_c11_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c12">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 12"; ?></label>
                                                <textarea name="mul_c12_eng" id="mul_c12_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c13">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 13"; ?></label>
                                                <textarea name="mul_c13_eng" id="mul_c13_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c14">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 14"; ?></label>
                                                <textarea name="mul_c14_eng" id="mul_c14_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c15">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 15"; ?></label>
                                                <textarea name="mul_c15_eng" id="mul_c15_eng" rows="5" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 input_svdedetail_th" style="display:none;">
                                    <div class="ribbon-wrapper card">
                                        ...
                                        <div class="ribbon-content row">
                                            ...
                                            <div class="form-group col-md-6 mul_c6">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 6"; ?></label>
                                                <textarea name="mul_c6_th" id="mul_c6_th" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c7">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 7"; ?></label>
                                                <textarea name="mul_c7_th" id="mul_c7_th" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c8">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 8"; ?></label>
                                                <textarea name="mul_c8_th" id="mul_c8_th" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c9">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 9"; ?></label>
                                                <textarea name="mul_c9_th" id="mul_c9_th" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c10">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 10"; ?></label>
                                                <textarea name="mul_c10_th" id="mul_c10_th" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c11">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 11"; ?></label>
                                                <textarea name="mul_c11_th" id="mul_c11_th" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c12">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 12"; ?></label>
                                                <textarea name="mul_c12_th" id="mul_c12_th" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c13">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 13"; ?></label>
                                                <textarea name="mul_c13_th" id="mul_c13_th" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c14">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 14"; ?></label>
                                                <textarea name="mul_c14_th" id="mul_c14_th" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c15">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 15"; ?></label>
                                                <textarea name="mul_c15_th" id="mul_c15_th" rows="5" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 input_svdedetail_jp" style="display:none;">
                                    <div class="ribbon-wrapper card">
                                        ...
                                        <div class="ribbon-content row">
                                            ...
                                            <div class="form-group col-md-6 mul_c6">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 6"; ?></label>
                                                <textarea name="mul_c6_jp" id="mul_c6_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c7">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 7"; ?></label>
                                                <textarea name="mul_c7_jp" id="mul_c7_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c8">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 8"; ?></label>
                                                <textarea name="mul_c8_jp" id="mul_c8_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c9">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 9"; ?></label>
                                                <textarea name="mul_c9_jp" id="mul_c9_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c10">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 10"; ?></label>
                                                <textarea name="mul_c10_jp" id="mul_c10_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c11">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 11"; ?></label>
                                                <textarea name="mul_c11_jp" id="mul_c11_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c12">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 12"; ?></label>
                                                <textarea name="mul_c12_jp" id="mul_c12_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c13">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 13"; ?></label>
                                                <textarea name="mul_c13_jp" id="mul_c13_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c14">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 14"; ?></label>
                                                <textarea name="mul_c14_jp" id="mul_c14_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                            <div class="form-group col-md-6 mul_c15">
                                                <label class="control-label text-right"><?php echo label('sv_b_choice')." 15"; ?></label>
                                                <textarea name="mul_c15_jp" id="mul_c15_jp" rows="5" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                  ...
                                  <div class="col-md-12 progress" id="progress_publicsurveyquestion_div" style="display: none;">
                                      <div class="progress-bar-publicsurveyquestion bg-danger" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width:0%; height:6px;"><span class="sr-only" id="txt_progress_publicsurveyquestion"></span></div>
                                  </div>
