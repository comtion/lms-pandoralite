                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">
                          <table id="myTable" width="100%" class="table table-bordered table-striped">
                            <thead>
                              <tr>
                                  <th style="min-width: 55px !important;"><center><?php echo label('manage'); ?></center></th>
                                  <th width="5%"></th>
                                  <!-- <th width="10%"><center><?php echo label('cosCode'); ?></center></th> -->
                                  <th width="15%"><center><?php echo label('ceCname'); ?></center></th>
                                  <th width="10%"><center><?php echo label('ceCforlang'); ?></center></th>
                                  <th width="10%"><center><?php echo label('da_approve_creator'); ?></center></th>
                            <?php if(in_array($user['ug_id'], array('1','2','6'))){ ?>
                                  <th width="15%"><center><?php echo label('com_name'); ?></center></th>
                            <?php } ?>
                                  <th width="10%"><center><?php echo label('approval_status'); ?></center></th>
                                  ...
                                  <th width="10%"><center><?php echo label('dateMod'); ?></center></th>
                              </tr>
                            </thead>
                          </table>
                      </div>
                      <p class="precision-table-legend"><?php echo label('preNote'); ?>: <button type="button" class="btn btn-primary btn-xs"><i class="mdi mdi-eye"></i></button> = <b><?php echo label('sample_course'); ?></b> , <button type="button" class="btn btn-info btn-xs"><i class="mdi mdi-note-multiple"></i></button> = <b><?php echo label('ceDetailCourse'); ?></b><?php if($user['ug_approve']=="1"){ ?> , <button type="button" class="btn btn-secondary btn-xs active"><i class="mdi mdi-alert text-warning"></i></button> = <b><?php echo label('d_waitapprove'); ?></b><?php } ?><?php if($btn_update=="1"){ ?> , <button type="button" class="btn btn-warning btn-xs"><i class="mdi mdi-lead-pencil"></i></button> = <b><?php echo label('m_edit'); ?></b><?php } ?><?php if($btn_delete=="1"){ ?> , <button type="button" class="btn btn-danger btn-xs"><i class="mdi mdi-window-close"></i></button> = <b><?php echo label('delete'); ?></b><?php } ?></p>
                    </div>
                  </div>
                </div>
                  ...
                  success:function(data)
                  {
                        ...
                        $('#div_create_pp').show();
                         $.ajax({
                              ...
                              type: 'POST',
                              data:{course_id:cos_id,cosde_id:data.cosde_id},
