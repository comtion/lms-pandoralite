        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="card card-body" style="max-height: 350px;overflow-y: scroll;">
              ...
              <?php if(isset($arr_welcome['wcmessage_a']) && $arr_welcome['wcmessage_a']!=""){ ?>
                <div class="" id="page_a">
                <!-- Content -->
                <?php echo $arr_welcome['wcmessage_a']; ?>
                </div>
              <?php } ?>
              <?php if(isset($arr_welcome['wcmessage_b']) && $arr_welcome['wcmessage_b']!=""){ ?>
            ...
            <?php if(isset($arr_welcome['wcmessage_a']) && $arr_welcome['wcmessage_a']!="" && $arr_welcome['wcmessage_b']!=""){ ?>
            ...
            <?php } ?>
            <?php if(isset($arr_msg_confirm)&&countArray($arr_msg_confirm)>0){ $num=1;
          ...
          <div class="modal-footer">
            <button data-dismiss="modal" type="button" title="<?php echo label('m_ok'); ?>" class="btn waves-effect waves-light btn-outline-danger btn-danger-hover float-right" onclick="confirmfirsttime()" id="confirm_button"><i class="mdi mdi-file-document-box"></i><?php echo ' '.label('m_ok'); ?></button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
