                        ...
                        <div class="card-body row">
                            <div class="col-md-12">
                                <?php
                                    if($user['Is_admin']=="1"){ ?>
                                      <?php if($btn_add=="1"){ ?>
                                    <div class="row col-xs-12 float-right">
                                        <button name="add_button" id="add_button" class="btn btn-outline-info add_button " data-toggle="modal" data-target="#modal-default"><i class="mdi mdi-plus-box-outline"></i> <?php echo label('create').label('course'); ?></button><br>
                                    </div>
                                      <?php } ?>
                                          ...
                                          <table id="myTable" width="100%" class="table table-bordered table-striped">
                                            <thead>
                                              <tr>
                                                ...
                                                <th width="20%" align="center"><?php echo label('cgtitle'); ?></th>
                                                <th width="10%" align="center"><?php echo label('wtitle'); ?></th>
                                                <th width="20%" align="center"><?php echo label('dateMod'); ?></th>
                                      ...
                                      <div class="table-responsive">
                                        <table id="myTable" width="100%" class="table table-bordered table-striped">
                                          <thead>
                                            <tr>
                                              <th width="10%"></th>
                                              <th width="25%" align="center"><?php echo label('ceCname'); ?></th>
                                              <th width="15%" align="center"><?php echo label('cgtitle'); ?></th>
                                              <th width="15%" align="center"><?php echo label('wtitle'); ?></th>
                                              <th width="15%" align="center"><?php echo label('com_name'); ?></th>
                                              <th width="10%" align="center"><?php echo label('dateMod'); ?></th>
                                              <th width="10%" align="center"><?php echo label('action'); ?></th>
                                            </tr>
                                          </thead>
                                        </table>
                                ...
                                <script type="text/javascript">
                                    ...
                                    function load_dataondiv(value=""){
                                      ...
                                      $.ajax({
                                          ...
                                          method:"POST",
                                          data:{value:value,cgcode:cgcode,wcode:wcode,page:page},
