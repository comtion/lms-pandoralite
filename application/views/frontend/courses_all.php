...
#modal-detail-course .form-control {
    background-color: #f0f0f0; /* สีพื้นหลังเป็นสีเทาอ่อน */
    color: #808080; /* สีข้อความเป็นสีเทา */
    border-color: #dcdcdc; /* สีขอบเป็นสีเทาอ่อน */
}
#modal-detail-course .select2-container--default .select2-selection--single {
    background-color: #f0f0f0; /* สีพื้นหลังเป็นสีเทาอ่อน */
    color: #808080; /* สีข้อความเป็นสีเทา */
    border-color: #dcdcdc; /* สีขอบเป็นสีเทาอ่อน */
}

#modal-detail-course .select2-container--default .select2-selection--multiple {
    background-color: #f0f0f0; /* สีพื้นหลังเป็นสีเทาอ่อน */
    color: #808080; /* สีข้อความเป็นสีเทา */
    border-color: #dcdcdc; /* สีขอบเป็นสีเทาอ่อน */
}
...
<!-- <link href="<?php echo REAL_PATH; ?>/assets/css/progressbar_circular.css" rel="stylesheet"> -->
</head>
...
<body class="fix-header fix-sidebar card-no-border">
      ...
      <div class="container-fluid">
        ...
        <div class="row col-12 page-titles" id="div_maincourse">
          <div class="col-md-12 card">
            <div class="card-body">
              <div class="col-md-12">
                <?php if ($btn_add == "1") { ?>
                <button name="add_button" id="add_button" class="btn btn-outline-info add_button float-right"
                  data-toggle="modal" data-target="#modal-default"><i class="mdi mdi-plus-box-outline"></i>
                  <?php echo label('createcourse'); ?></button>
                <?php } ?>
                <?php if ($btn_print == "1") { ?>
                <button name="export_button" id="export_button"
                  class="btn btn-outline-success export_button float-right"><i class="mdi mdi-file-excel"></i>
                  <?php echo label('export_data_main'); ?></button>
                <?php } ?>
                  ...
                  <div class="col-md-6">
                    ...
                    <select class="form-control select2" id="com_id_search" name="com_id_search" style="width: 100%;">
                      ...
                      <optgroup label="<?php echo label('sv_b_select_com_name'); ?>">
                        ...
                        <option value="<?php echo $value_com['com_id']; ?>" <?php if ($numloop == 1) {
                                                                                    echo "selected";
                                                                                  }
                                                                                  $numloop++; ?>>
              ...
              <div class="table-responsive">
                <table id="myTable" width="120%" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th width="10%" style="min-width: 100px !important;">
                        <center><?php echo label('manage'); ?></center>
                      </th>
                      <th width="5%"></th>
                      <!-- <th width="10%"><center><?php echo label('cosCode'); ?></center></th> -->
                      <th style="min-width: 250px !important;">
                        <center><?php echo label('ceCname'); ?></center>
                      </th>
                      <th width="10%">
                        <center><?php echo label('ceCforlang'); ?></center>
                      </th>
                      <th width="10%">
                        <center><?php echo label('perioddate'); ?></center>
                      </th>
                      <th width="10%">
                        <center><?php echo label('numSeat'); ?></center>
                      </th>
                      <th width="10%">
                        <center><?php echo label('da_approve_creator'); ?></center>
                      </th>
                      ...
                      <th width="10%">
                        <center><?php echo label('approval_status'); ?></center>
                      </th>
                      <th width="10%">
                        <center><?php echo label('d_approvedate'); ?></center>
                      </th>
                      <th width="10%">
                        <center><?php echo label('d_approver'); ?></center>
                      </th>
                      <th width="5%">
              ...
              <!-- <div class="table-responsive">
                          <table id="myTable" width="<?php if (in_array($user['ug_id'], array('1', '2', '6'))) { ?>1070<?php } else { ?>1030<?php } ?>" class="table table-bordered table-striped">
                            <thead>
                              <tr>
                                  <th width="70"><center><?php echo label('manage'); ?></center></th>
                                  <th width="30"></th>
                                  <th width="150"><center><?php echo label('ceCname'); ?></center></th>
                                  <th width="100"><center><?php echo label('ceCforlang'); ?></center></th>
                                  <th width="100"><center><?php echo label('perioddate'); ?></center></th>
                                  <th width="70"><center><?php echo label('numSeat'); ?></center></th>
                                  <th width="100"><center><?php echo label('da_approve_creator'); ?></center></th>
                            <?php if (in_array($user['ug_id'], array('1', '2', '6'))) { ?>
                                  <th width="100"><center><?php echo label('com_name'); ?></center></th>
                            <?php } ?>
                            
                                  <th width="100"><center><?php echo label('approval_status'); ?></center></th>
                                  <th width="100"><center><?php echo label('d_approvedate'); ?></center></th>
                                  <th width="100"><center><?php echo label('d_approver'); ?></center></th>
                                  <th width="50"><center><?php echo label('status'); ?></center></th>
                                  <th width="100"><center><?php echo label('dateMod'); ?></center></th>
                              </tr>
                            </thead>
                          </table>
                      </div> -->
              ...
              <?php } ?>
                  <button type="button" class="btn btn-primary btn-xs"><i class="mdi mdi-eye"></i></button> =
                    <b><?php echo label('sample_course'); ?></b> ,
                  <button type="button" class="btn btn-info btn-xs"><i class="mdi mdi-note-multiple"></i></button> =
                    <b><?php echo label('ceDetailCourse'); ?></b> ,
                  <button type="button" class="btn btn-info btn-xs"><i class="mdi mdi-magnify"></i></button> =
                    <b><?php echo label('courseSummary'); ?></b>
              <?php if ($user['ug_approve'] == "1") { ?> ,
                  <button type="button" class="btn btn-secondary btn-xs active"><i class="mdi mdi-alert text-warning"></i></button> =
                    <b><?php echo label('d_waitapprove'); ?></b>
              <?php } ?>
              <?php if ($btn_update == "1") { ?> ,
                <button type="button" class="btn btn-warning btn-xs"><i class="mdi mdi-lead-pencil"></i></button> =
                  <b><?php echo label('m_edit'); ?></b>
              <?php } ?>
              <?php if ($btn_delete == "1") { ?> ,
                <button type="button" class="btn btn-danger btn-xs"><i class="mdi mdi-window-close"></i></button> =
                  <b><?php echo label('delete'); ?></b>
              <?php } ?></p>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-4" align="left">
                  <button class="btn btn-outline-info float-left" onclick="location.reload()"><i
                      class="mdi mdi-keyboard-return"></i> <?php echo label('m_previous_courses'); ?></button>
                </div>
              </div>
            </div>
            <div class="card-body">
              <div class="ribbon-wrapper card">
                <div class="ribbon ribbon-danger"><i class="mdi mdi-note-multiple"></i>
                  <?php echo label('ceDetailCourse'); ?> : <span id="txtname_cosdetail"></span></div>
                <div class="ribbon-content">
                  <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#period_and_permission"
                        role="tab" title="<?php echo label('period_and_permission'); ?>" onclick="run_create_pp()"><span
                          class="hidden-sm-up"><i class="mdi mdi-file-document"></i></span> <span
                          class="hidden-xs-down"><?php echo label('period_and_permission'); ?></span></a> </li>
                    <li class="nav-item" id="li_lesson"> <a class="nav-link" data-toggle="tab"
                        onclick="display_disable('div_create_lesson','div_lesson')" href="#lesson" role="tab"
                        title="<?php echo label('lesson'); ?>"><span class="hidden-sm-up"><i
                            class="mdi mdi-file-document"></i></span> <span
                          class="hidden-xs-down"><?php echo label('lesson'); ?></span></a> </li>
                    <li class="nav-item" id="li_quiz"> <a class="nav-link" data-toggle="tab"
                        onclick="display_disable('div_create_quiz','div_quiz')" href="#quiz" role="tab"
                        title="<?php echo label('quiz'); ?>"><span class="hidden-sm-up"><i
                            class="mdi mdi-file-document"></i></span> <span
                          class="hidden-xs-down"><?php echo label('quiz'); ?></span></a> </li>
                    <li class="nav-item" id="li_survey"> <a class="nav-link" data-toggle="tab"
                        onclick="display_disable('div_create_survey','div_survey')" href="#survey" role="tab"
                        title="<?php echo label('survey'); ?>"><span class="hidden-sm-up"><i
                            class="mdi mdi-file-document"></i></span> <span
                          class="hidden-xs-down"><?php echo label('survey'); ?></span></a> </li>
                    <li class="nav-item" id="li_enroll"> <a class="nav-link" data-toggle="tab"
                        onclick="display_disable('div_enroll_cancel','div_enroll_main')" href="#enroll" role="tab"
                        title="<?php echo label('student_enroll'); ?>"><span class="hidden-sm-up"><i
                            class="mdi mdi-file-document"></i></span> <span
                          class="hidden-xs-down"><?php echo label('student_enroll'); ?></span></a> </li>
                    ...
                    <li class="nav-item" id="nav-item_document"> <a class="nav-link" data-toggle="tab" href="#document"
                        onclick="clicktabdoccos()" role="tab"><span class="hidden-sm-up"><i
                            class="mdi mdi-file-document"></i></span> <span
                          class="hidden-xs-down"><?php echo label('lesson_file'); ?></span></a> </li>
                  </ul>
        ...
        <div class="row col-12 page-titles" id="div_demoofcourse" style="display: none;">
          <div class="col-md-12 card">
            <div class="card-body">
              <div class="ribbon-wrapper card">
                <div class="ribbon ribbon-danger"><i class="mdi mdi-view-dashboard"></i>
                  <?php echo label('sample_course'); ?> : <span id="txtname_cosdemo"></span></div>
                <div class="ribbon-content">
                  <div class="jumbotron">
  ...
  <?php $this->load->view('frontend/modal/modal_course_cannot_edit.php'); ?>

  <div id="myModal_process" class="modal bs-example-modal-lg" role="dialog" aria-labelledby="smallModalLabel"
    aria-hidden="true">
  ...
  <script src="<?php echo REAL_PATH; ?>/assets/js/mediainfo.min.js"></script>
  <script type="text/javascript">
  </script>
  <?php $this->load->view('frontend/java/course_java.php'); ?>
  <?php $this->load->view('frontend/java/course_view_detail.php'); ?>
  <script type="text/javascript">
        ...
        if (data.isData_period == "1") {
          ...
          $.ajax({
            ...
            success: function(data_pp) {
              ...
              setCoursePeriodInputValues(data_pp);
              ...
              if (data_pp.date_start != "") {
                $('#date_start').datepicker('setStartDate', data_pp.date_start_condition || data_pp.date_start);
                $('#date_end').datepicker('setStartDate', data_pp.date_start_condition || data_pp.date_start);
              }
              if (data_pp.date_end != "") {
  ...
  $(document).on('click', '.demo_course', function() {
    ...
    /*document.getElementById('div_detailofcourse').style.display = "none";
    document.getElementById('div_demoofcourse').style.display = "";
    ...
    $.ajax({
      ...
      {
          if(data.cos_pic!=""){
            $("#course_cover").attr("src","<?php echo REAL_PATH; ?>/uploads/course/"+data.cos_pic);
          }else{
            $("#course_cover").attr("src","<?php echo REAL_PATH; ?>/images/logo.png");
          }
          if(data.isTH=="1"){
              $('#course_lang').append('<option value="th" data-icon="flag-icon flag-icon-th" '+data.is_lang_user_th+'><?php echo label('thai'); ?></option>');
          }
          if(data.isENG=="1"){
              $('#course_lang').append('<option value="eng" data-icon="flag-icon flag-icon-us" '+data.is_lang_user_eng+'><?php echo label('english'); ?></option>');
          }
          if(data.isJP=="1"){
              $('#course_lang').append('<option value="jp" data-icon="flag-icon flag-icon-jp" '+data.is_lang_user_jp+'><?php echo label('japan'); ?></option>');
          }
          $('#course_lang').val(data.select_lang).trigger('change');
          $("#txt_period_course").text(data.txt_period_course);
          $('#txtname_cosdemo').text(data.cname_main);
          $('#course_name').text(data.cname_main);
      }
    });*/
  });
  ...
  $(document).on('click', '.detail_course', function() {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        if (data.isJP == "1") {
          $('.input_cosv_jp').show();
          $('#fil_lang').append('<option value="jp"><?php echo label('japan'); ?></option>');
          $('#cosv_lang').append('<option value="jp"><?php echo label('japan'); ?></option>');
        }
  ...
  function create_div(div_name, div_main, form_name) {
    ...
    if (form_name == "period_and_permission_form") {
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data.isData == "1") {
            ...
            $("#date_end_les").datepicker("setDate", EndDate);
          } else {
            var startDate = new Date();
            $('#date_start_les').datepicker('setStartDate', startDate);
            $('#date_end_les').datepicker('setStartDate', startDate);
      ...
      $(function() {
        ...
        /*.on('changeDate', function (selected) {
            $('#period_end').val('');
            $('#period_open').datepicker("update", selected.date);
                 to = $('#period_end').datepicker({
                        ...
                        var res_date = date_val.split("-");
                        maxDate = res_date[2]+"/"+res_date[1]+"/"+(parseInt(res_date[0]));
                        $('#period_open').datepicker('setEndDate', maxDate);
                    });
        });*/
        to = $('#period_end').datepicker({
          <?php if ($lang == "thai") { ?>
        ...
        /*.on('changeDate', function (selected) {
           $('#period_end').datepicker("update", selected.date);
               var maxDate = new Date(selected.date.valueOf()).toLocaleString("en-US", {timeZone: "Asia/Bangkok"});
               var date_val = moment(maxDate).format('YYYY-MM-DD');
               var res_date = date_val.split("-");
               maxDate = res_date[2]+"/"+res_date[1]+"/"+(parseInt(res_date[0]));
      ...
      /*$.ajax({
            ...
            success: function(data){
                $('#sv_lang').html(data);
                $('#sv_lang').val($('#sv_lang option:first-child').val()).trigger('change');
            }
      });*/
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data.isData == "1") {
            ...
            $("#survey_end").datepicker("setDate", EndDate);
          } else {
            var startDate = new Date();
            $('#survey_open').datepicker('setStartDate', startDate);
            $('#survey_end').datepicker('setStartDate', startDate);
      ...
      val_lang('0', 'input_ques_jp', 'ques_name_', 'jp');
        ...
        success: function(data) {
          for (var i = data.arr_lang.length - 1; i >= 0; i--) {
            ...
            if (data.arr_lang[i] == "jp") {
              ...
              $(tinymce.get('ques_name_jp').getBody()).html('');
              $(tinymce.get('ques_info_jp').getBody()).html('');
            }
          }
        }
      });
    ...
    if (div_main == 'div_enroll_main') {
      ...
      $.ajax({
          ...
          success:function(data)
          {
              ...
              $("#enroll").find("input,select,textarea,button").prop("disabled",false);
              <?php if ($user['u_id'] != "1") { ?>
              if(data.cos_approve=="1"){
              $("#enroll").find("input,select,textarea,button").prop("disabled",true);
              }
              <?php } ?>
          }
      });*/
      ...
      /*$.ajax({
            ...
            success: function(data){
              ...
              if(data == "1"){
                  document.getElementById('manage_quiz_div').style.display = '';
              }else{
                  document.getElementById('manage_quiz_div').style.display = 'none';
              }
            }
      });*/
    }
