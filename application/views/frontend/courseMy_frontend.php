        ...
        <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox" style="height: 200px;">
            <div class="carousel-item active">
              <img class="carousel-course" src="<?php echo REAL_PATH; ?>/assets/images/bg.jpg" width="100%" alt="First slide">
                <div class="carousel-caption d-md-block">
                <h1 class="container-fluid text-white"><?php echo label('mycos'); ?></h1>
              </div>
            </div>
            <div class="carousel-item">
              <img class="carousel-course" src="<?php echo REAL_PATH; ?>/assets/images/bg.jpg" width="100%" alt="Second slide">
              <div class="carousel-caption d-md-block">
                <h1 class="container-fluid text-white"><?php echo label('mycos'); ?></h1>
              </div>
            </div>
            <div class="carousel-item">
              <img class="carousel-course" src="<?php echo REAL_PATH; ?>/assets/images/bg.jpg" width="100%" alt="Third slide">
              <div class="carousel-caption d-md-block">
                <h1 class="container-fluid text-white"><?php echo label('mycos'); ?></h1>
              </div>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12 col-lg-9 card card-body">
                    ...
                    <div class="card-group">
                      ...
                      <!-- CARD 3 -->
                      <div class="card">
                        <img class="card-img-top img-responsive pointer" src="<?php echo REAL_PATH;?>/assets/images/mockup/img2.jpg" onerror="this.src='<?php echo REAL_PATH;?>/images/logo.png';" alt="Card image cap" onclick="location.href='<?php echo REAL_PATH;?>/course/detail';" >
                        <div class="card-body">
                          <h4 class="card-title h4-two-line-ellipsis pointer" onclick="location.href='<?php echo REAL_PATH;?>/course/detail';" title="Card title">Card title</h4>
                          <p class="card-text"><?php echo label('period').' : '; ?> 
                            <br>1 January 2563 - 3 March 2563
