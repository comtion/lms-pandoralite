      ...
      <div class="container-fluid">
        <div class="row page-titles">
          <div class="col-5 align-self-center">
              <b><?php echo label('managecompany'); ?></b>
          </div>
          <div class="col-7 align-self-right ">
            <ol class="breadcrumb float-right">
              ...
              <li class="breadcrumb-item"><a><?php echo label('manageusers'); ?></a></li>
              <li class="breadcrumb-item active"><?php echo label('managecompany'); ?></li>
            </ol>
          </div>
        </div>
                  ...
                  <div class="col-sm-12 card card-body">
                    <div class="table-responsive">
                      <table id="report_course_table" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                          <tr>
                            <th><?php echo label('manage'); ?></th>
                            <th><?php echo label('acronym'); ?></th>
                            <th><?php echo label('com_name'); ?></th>
                            <th><?php echo label('status'); ?></th>
                            <th><?php echo label('m_updatedate'); ?></th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td class="text-center">
                              <button type="button" name="banner" id="21" title="Banner" class="btn btn-info btn-xs banner"><i class="mdi mdi-image-area"></i></button>
                              <button type="button" name="update" id="21" title="Edit" class="btn btn-warning btn-xs update"><i class="mdi mdi-lead-pencil"></i></button>
                            </td>
                            <td title="IGCE">IGCE</td>
                            <td title="Isuzu Global CV Engineering Center Co., Ltd.">Isuzu Global CV Engineering Center Co., Ltd.</td>
                            <td>Associated company</td>
                            <td>06/02/2020 18:50</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
